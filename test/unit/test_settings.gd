...
func test_show_soldier_ids_defaults_off_and_round_trips() -> void:
	# Default off, like every other opt-in debug overlay (show_unit_speed). See sparta#675.
	assert_false(_settings().show_soldier_ids, "soldier-ID overlay defaults off")
