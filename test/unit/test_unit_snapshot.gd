...
func test_to_snapshot_dict_round_trips_every_captured_field() -> void:
	...
	assert_almost_eq(restored.missile_gravity, original.missile_gravity, 0.001)
...
func test_snapshot_restore_defaults_legacy_missile_and_range_fields() -> void:
	...
	assert_almost_eq(restored.missile_gravity, ProjectileField.GRAVITY, 0.001)
