...
(usually the highest-numbered one) rather than growing this aggregator. Existing references
...
@.claude/memories/sparta/03-multi-pair-force-accumulation-needs-a-write-back.md
@.claude/memories/sparta/04-battlegd-order-dispatch-applies-every-live.md
@.claude/memories/sparta/05-leading-tabs-vs-read-separator-tab.md
