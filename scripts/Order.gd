...
var weapon: int = 0
## Whether this order was forced (commanded explicitly by player/script) vs unforced
## (generated by stance reaction or AI auto-acquisition). Retaliation and auto-target
## acquisition can only preempt unforced orders.
