...
const _ROWS: Array = [
	...
	["Reinforce: insert by files (arm, then RMB host)", "Shift+M"],
	["Reinforce: insert by ranks (arm, then RMB host)", "Ctrl+Shift+M"],
	["— Stances (Esc clears) —", ""],
	["STANCES", ""],
	...
	["Anti-cavalry square: orbis / schiltron (toggle direct)", "O / Shift+O"],
	...
	["Countermarch: Laconian (withdraw)", "Ctrl+Shift+V"],
	["— Control groups —", ""],
	...
	["Fog of war (hide enemies outside your units' sight)", "F7"],
	["— Help —", ""],
