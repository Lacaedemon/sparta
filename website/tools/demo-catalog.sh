...
DEMOS=(
  ...
  "sprint_reshape|demos/inputs/sprint-reshape-reversal.json|30|340|640|input"
  ...
  # trapped_routing holds west of the hill: a south-of-hill spawn is herded off the flee lane.
  ...
  "interval_labels|demos/inputs/interval-labels.json|30|360|640|input"
