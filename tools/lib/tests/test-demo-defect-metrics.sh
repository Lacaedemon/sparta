...
# tools/lib/demo-defect-metrics.sh -- exercises the three cases the function's own
# header comment claims to handle without needing a Godot binary or the real catalog:
